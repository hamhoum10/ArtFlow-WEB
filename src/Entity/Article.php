 ...
 * Article
 *
 * @ORM\Table(name="article", uniqueConstraints={@ORM\UniqueConstraint(name="type", columns={"type"})}, indexes={@ORM\Index(name="id_categorie", columns={"id_categorie"}), @ORM\Index(name="id_artiste", columns={"id_artiste"})})
 * @ORM\Entity
 */
class Article
{
