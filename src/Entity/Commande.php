 ...
 * Commande
 *
 * @ORM\Table(name="commande", indexes={@ORM\Index(name="id_panierFK", columns={"id_panier"})})
 * @ORM\Entity
 */
class Commande
{
     ...
     * @var string
     *
     * @ORM\Column(name="les_articles", type="string", length=255, nullable=false)
     */
    private $lesArticles;
    ...
    public function getLesArticles(): ?string
    {
        return $this->lesArticles;
    }

    public function setLesArticles(string $lesArticles): self
    {
