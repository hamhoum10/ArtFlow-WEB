...
class LignePanierController extends AbstractController
{
    ...
    public function index(EntityManagerInterface $entityManager, SessionInterface $session): Response
    {
        ...
        return $this->render('ligne_panier/PanierBase.html.twig', [  //ligne_panier/index1.html.twig before
    ...
    public function new(Request $request, EntityManagerInterface $entityManager,Security $security,SessionInterface $session): JsonResponse
    {
...
//        var_dump($session->get("username"));
        ...
        $client = $entityManager->getRepository(Client::class)->findby(["username"=> $session->get("username")/*$user->getUserIdentifier()*/]); //tjib client bid 3 maybe nada send me the client when login
        $panierparclient = $entityManager->getRepository(Panier::class)->findOneBy(['idClient' => $client]);
