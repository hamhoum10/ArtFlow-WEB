...
class ArtisteController extends AbstractController
{
    ...
    public function welcomepage(EntityManagerInterface $entityManager,Request $request, Security $security, ArtisteRepository $artisteRepository,SessionInterface $session): Response
    {
        $user = $security->getUser();
        $session->set("usernameartiste",$user->getUserIdentifier());
        $artiste=$entityManager->getRepository(Artiste::class)->findOneBy(['username'=>$user->getUserIdentifier()]);
        return $this->render('artiste/ArtisteindexFrontPage.html.twig', [
            'controller_name' => 'ArtisteController', 'artiste'=>$artiste,
        ]);
    }

    #[Route('/profileart', name: 'app_profile_artiste')]
    public function profile(EntityManagerInterface $entityManager,Request $request, Security $security): Response
    {
        ...
        return $this->render('artiste/ProfileArtiste.html.twig', [
            'controller_name' => 'ArtisteController', 'artiste'=>$artiste,
        ]);
    }
    ...
    public function index(ArtisteRepository $artisteRepository, Request $request): Response
    {
        ...
        $artistes = $artisteRepository->createQueryBuilder('p')
            ...
            ->getQuery()
            ->getResult();
        return $this->render('artiste/index1.html.twig', [
    ...
    public function edit(Request $request, Artiste $artiste, ArtisteRepository $artisteRepository,EntityManagerInterface $entityManager, UserRepository $userRepository, UserPasswordHasherInterface $userPasswordHasher): Response
    {
        ...
        return $this->renderForm('artiste/settingsArtiste.html.twig', [
