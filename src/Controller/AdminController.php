...
class AdminController extends AbstractController
{
    ...
    public function someAction(ClientRepository $clientRepository,Security $security, ArtisteRepository $artisteRepository, EntityManagerInterface $entityManager,SessionInterface $session): Response
    {
        ...
        $session->set('usernameadmin', $user->getUserIdentifier());
    ...
    public function index(AdminRepository $adminRepository,Security $security,SessionInterface $session): Response
    {
        $user = $security->getUser();
        $session->set('usernameadmin', $user->getUserIdentifier());
//      $session->set('usernameartiste',"vide");
