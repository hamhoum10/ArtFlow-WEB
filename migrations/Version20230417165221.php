 ...
 */
final class Version20230417165221 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE commande ADD lesarticles VARCHAR(255) DEFAULT NULL, CHANGE prenom prenom VARCHAR(150) NOT NULL, CHANGE nom nom VARCHAR(150) NOT NULL, CHANGE status status VARCHAR(150) NOT NULL, CHANGE created_at created_at VARCHAR(255) NOT NULL, CHANGE adresse adresse VARCHAR(150) NOT NULL');
