 ...
 */
final class Version20230414053928 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE favori (id INT AUTO_INCREMENT NOT NULL, article INT DEFAULT NULL, Artiste INT DEFAULT NULL, INDEX IDX_EF85A2CC53BA0CD3 (Artiste), INDEX IDX_EF85A2CC23A0E66 (article), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE favori ADD CONSTRAINT FK_EF85A2CC53BA0CD3 FOREIGN KEY (Artiste) REFERENCES artiste (idArtiste)');
        $this->addSql('ALTER TABLE favori ADD CONSTRAINT FK_EF85A2CC23A0E66 FOREIGN KEY (article) REFERENCES article (idArticle)');
        ...
        $this->addSql('ALTER TABLE article DROP FOREIGN KEY article_ibfk_1');
        $this->addSql('ALTER TABLE article CHANGE id_categorie id_categorie INT DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE article ADD CONSTRAINT article_ibfk_1 FOREIGN KEY (id_categorie) REFERENCES categorie (id_categorie) ON UPDATE CASCADE ON DELETE CASCADE');
        $this->addSql('ALTER TABLE artiste CHANGE username username VARCHAR(255) NOT NULL, CHANGE firstname firstname VARCHAR(255) NOT NULL, CHANGE lastname lastname VARCHAR(255) NOT NULL, CHANGE birthplace birthplace VARCHAR(255) NOT NULL, CHANGE birthdate birthdate VARCHAR(255) NOT NULL, CHANGE description description VARCHAR(255) NOT NULL, CHANGE image image VARCHAR(255) NOT NULL, CHANGE address address VARCHAR(255) NOT NULL, CHANGE phonenumber phonenumber VARCHAR(255) NOT NULL, CHANGE email email VARCHAR(255) NOT NULL, CHANGE password password VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE participant (idp INT AUTO_INCREMENT NOT NULL, id INT NOT NULL, ide INT NOT NULL, montant DOUBLE PRECISION NOT NULL, INDEX fkclientttt (id), INDEX fkencheeee (ide), PRIMARY KEY(idp)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_general_ci` ENGINE = InnoDB COMMENT = \'\' ');
        ...
        $this->addSql('CREATE TABLE rating (id_rating INT AUTO_INCREMENT NOT NULL, id_article INT NOT NULL, id_rater INT NOT NULL, rate DOUBLE PRECISION NOT NULL, INDEX id_rater (id_rater), INDEX id_article (id_article), PRIMARY KEY(id_rating)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_general_ci` ENGINE = InnoDB COMMENT = \'\' ');
        $this->addSql('CREATE TABLE reservation (id_res INT AUTO_INCREMENT NOT NULL, id_client INT NOT NULL, id_event INT NOT NULL, nb_place INT NOT NULL, dateres DATE DEFAULT NULL, INDEX id_event (id_event), INDEX id_client (id_client), PRIMARY KEY(id_res)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_general_ci` ENGINE = InnoDB COMMENT = \'\' ');
