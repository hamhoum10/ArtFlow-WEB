 ...
 */
final class Version20230417163734 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX type ON article');
        $this->addSql('ALTER TABLE article DROP FOREIGN KEY id_artistefk');
        $this->addSql('ALTER TABLE article CHANGE id_artiste id_artiste INT DEFAULT NULL, CHANGE image image VARCHAR(255) NOT NULL, CHANGE id_categorie id_categorie INT DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE article ADD CONSTRAINT id_artistefk FOREIGN KEY (id_artiste) REFERENCES artiste (id_artiste)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE article DROP FOREIGN KEY FK_23A0E66C9486A13');
        $this->addSql('ALTER TABLE article CHANGE id_artiste id_artiste INT NOT NULL, CHANGE id_categorie id_categorie INT NOT NULL, CHANGE image image VARCHAR(255) DEFAULT NULL');
        $this->addSql('CREATE UNIQUE INDEX type ON article (type)');
