 ...
 */
final class Version20230328230617 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE article ADD CONSTRAINT FK_23A0E66B597FD62 FOREIGN KEY (idCategorie) REFERENCES categorie (idCategorie)');
        $this->addSql('CREATE INDEX IDX_23A0E66B597FD62 ON article (idCategorie)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE article DROP FOREIGN KEY FK_23A0E66B597FD62');
        $this->addSql('DROP INDEX IDX_23A0E66B597FD62 ON article');
